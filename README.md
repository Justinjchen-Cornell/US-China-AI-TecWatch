...
| 行业 | 子站 | 指数 | 2年趋势 | 研判要点（verdict） | 方法论 |
|---|---|---|---|---|---|
| 半导体 | `/semiconductor` | 44.3 | — | 2nm 三国杀 + 绕行战略：设备国产替代最确定，用"能源洼地"填"芯片高地" | [§一](docs/methodology.md#一半导体2nm-三国杀与绕行战略) |
| AI模型 | `/ai-models` | 52.9 | ▲+7.8 | 非对称战争：尖端收敛未超越，开源+成本对冲算力劣势，行业 Agent 农村包围城市 | [§二](docs/methodology.md#二ai-模型尖端收敛生态领先的非对称战争) |
| 量子计算 | `/quantum` | 43.8 | ▲+3.2 | 纠错过渡期：逻辑比特是分水岭，先投卖铲人（激光/制冷/测控） | [§三](docs/methodology.md#三量子计算纠错过渡期的卖铲人逻辑) |
| 可控核聚变 | `/fusion` | 48.2 | ▲+3.8 | 2027 SPARC vs BEST 对表：Q≥5-10 盈亏线，HTS 带材是通吃环节 | [§四](docs/methodology.md#四可控核聚变2027-对表与卖铲人首选组合) |
| AI生命科学 | `/bio` | 43.4 | ▲+3.6 | AlphaFold 三级跳+临床生死线：首个 AI 药获批将重置估值锚 | [§五](docs/methodology.md#五ai-生命科学alphafold-三级跳与临床生死线) |
| 具身智能 | `/embodied` | 53.6 | ▲+6.8 | 量产元年+脑手之争：灵巧手 17.3% BOM，卖手比卖整机赚钱十倍 | [§六](docs/methodology.md#六具身智能量产元年与脑手之争) |
